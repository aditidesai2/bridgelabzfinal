...
import com.bridgeLabz.objectOriented.NotExistException;
import com.bridgeLabz.objectOriented.clinic.ICliniqueService;
...
public class Implementation {
	...
	public static void searchDoctorAndBookAppointment() {
		...
		case 1:
			...
			try {
				if (service.searchDoctorBookAppointment("name", docName) != null)
				{
					return;
				}
				else
					
					throw new NotExistException ("Invalid input");
