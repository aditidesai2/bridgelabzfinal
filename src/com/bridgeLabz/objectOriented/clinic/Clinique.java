...
import com.bridgeLabz.objectOriented.Utility;
import com.bridgeLabz.objectOriented.clinic.controller.Appointment;
import com.bridgeLabz.objectOriented.clinic.model.Doctor;
import com.bridgeLabz.objectOriented.clinic.model.Patients;
		...
		switch (choice) 
		{
			...
			case 7:
					...
					do
					{
						...
						case 4: //Search doctors by specialization
							    System.out.println("Enter doctor by specialization");
							    String sp=u.inputString();
							    ald=f.FindbySpec(ald, sp);
							    System.out.println(ald);
						case 5:
								System.exit(0);
						default:
